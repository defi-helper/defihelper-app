...
import * as styles from './invest-tabs.css'
...
const Header = (props: Omit<InvestTabsProps, 'value'>) => {
...
export const InvestTabs = (props: InvestTabsProps) => {
  const children = Children.toArray(props.children).filter(isValidElement)
...
InvestTabs.Header = Header
InvestTabs.HeaderRight = HeaderRight
