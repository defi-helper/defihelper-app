...
import { settingsIntegrationSchema } from './settings-integration-lbank-form.validation'
import * as styles from './settings-integration-lbank-form.css'
...
export const SettingsIntegrationLbankForm: React.VFC<SettingsIntegrationDialogProps> =
  (props) => {
