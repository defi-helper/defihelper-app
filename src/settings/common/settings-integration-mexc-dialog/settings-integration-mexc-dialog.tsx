...
import { settingsIntegrationSchema } from './settings-integration-mexc-dialog.validation'
import * as styles from './settings-integration-mexc-dialog.css'
...
export const SettingsIntegrationMexcDialog: React.VFC<SettingsIntegrationDialogProps> =
  (props) => {
      ...
      <Dialog className={styles.root}>
        ...
        >
          <Typography className={styles.apiHint}>
            Please create an API key (with read permission only) in your MEXC
