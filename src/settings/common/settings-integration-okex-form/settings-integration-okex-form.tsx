...
import { settingsIntegrationHuobiSchema } from './settings-integration-okex-form.validation'
import * as styles from './settings-integration-okex-form.css'
...
export const SettingsIntegrationOkexForm: React.VFC<SettingsIntegrationDialogProps> =
  (props) => {
