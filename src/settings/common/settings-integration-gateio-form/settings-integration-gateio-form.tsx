...
import { settingsIntegrationSchema } from './settings-integration-gateio-form.validation'
import * as styles from './settings-integration-gateio-form.css'
...
export const SettingsIntegrationGateioForm: React.VFC<SettingsIntegrationDialogProps> =
  (props) => {
