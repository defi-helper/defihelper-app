...
import { settingsIntegrationSchema } from './settings-integration-bybit-form.validation'
import * as styles from './settings-integration-bybit-form.css'
...
export const SettingsIntegrationBybitForm: React.VFC<SettingsIntegrationDialogProps> =
  (props) => {
