...
import { GovernanceUnstake } from '~/common/load-adapter'
import { Link } from '~/common/link'
import { Typography } from '~/common/typography'
import { ButtonBase } from '~/common/button-base'
import { bignumberUtils } from '~/common/bignumber-utils'
import * as styles from './staking-gov-unstake-dialog.css'
import { toastsService } from '~/toasts'

export type StakingGovUnstakeDialogProps = {
  onConfirm: () => void
  methods?: GovernanceUnstake['methods']
  onSubmit: () => void
}
...
export const StakingGovUnstakeDialog: React.VFC<StakingGovUnstakeDialogProps> =
  (props) => {
