...
import * as styles from './staking-contract-adapter-dialog.css'

export type StakingContractAdapterDialogProps = {
  onConfirm: () => void
  steps: AdapterStep[]
  onSubmit?: () => void
  onLastStep?: () => void
...
export const StakingContractAdapterDialog: React.FC<StakingContractAdapterDialogProps> =
  () => {
